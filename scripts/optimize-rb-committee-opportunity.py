...
def main():
    ...
    for team,g in m[elig].groupby('team'):
        ...
        # True committee now requires actual hierarchy parity: the RB2 must be within 8 points of the RB1 and at least 88% of the RB1 hierarchy score. Talent alone only supports a 1B/complement role.
        parity=(hs>=.58 and hratio>=.88 and hgap<=.08)
        true=parity and evidence>=.58 and security<.67 and challenge>=hurdle and effective_evidence>=.40

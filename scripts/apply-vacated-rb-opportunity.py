...
def main():
    ...
    m['rb_vacated_departures']=m['rb_vacated_departures'].fillna(''); m['rb_vacated_opportunity_applied']=False; m['rb_vacated_opportunity_share']=0.; m['rb_vacated_inheritance_weight']=0.; m['rb_vacated_carry_delta']=0.; m['rb_vacated_target_delta']=0.; m['rb_vacated_team_carry_budget']=np.nan; m['rb_vacated_team_target_budget']=np.nan
    ...
    for tm,g in m[elig].groupby('team'):
        ...
        # Team-level opportunity budget: retain returning workload and explicitly spend most vacated opportunity.
        ...
        # Prevent the vacancy layer itself from inventing a radically larger team workload than last season.

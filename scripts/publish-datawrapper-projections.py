...
req("PUT",f"/charts/{cid}/data",("\n".join(lines)+"\n").encode(),"text/csv")
meta={"describe":{"intro":"The Roster Report model projections for QB, RB, WR and TE. Sort the Position column to group players by position.","byline":"The Roster Report","source-name":"The Roster Report Projection Model","notes":"RB/WR/TE include Standard, Half-PPR and PPR. QB includes 4-point and 6-point passing TD scoring."},"visualize":{"header":{"style":{"bold":True}},"table":{"striped":True,"row-height":"compact","mobile-first":True},"perPage":40,"pagination":True,"searchable":True,"sortTable":True,"columns":{"Pos":{"align":"center","width":"small"},"Pos Rank":{"align":"center","width":"small"},"Player":{"align":"left","bold":True,"width":"large","wrap":False},"Team":{"align":"center","width":"small"},"Opp":{"align":"center","width":"small"}}}}

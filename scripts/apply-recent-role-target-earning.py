...
def main():
    ...
    for team,g in m[eligible].groupby('team'):
        ...
        # Confirmed structural breakout: meaningful six/eight-game volume, recent share at
        # alpha/strong-WR2 levels, and the final four games do not collapse from the L6 role.
